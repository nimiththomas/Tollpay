...
public class UserChangePassword extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_userchange_password);
...
//    }
    ...
    public class changepassword extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... strings) {
            ...
            wb.setSoapObject("userchangepassword");
        ...
        protected void onPostExecute(String s) {
            ...
            Toast.makeText(UserChangePassword.this, s, Toast.LENGTH_SHORT).show();

            Intent i = new Intent(UserChangePassword.this, UserProfile.class);
            startActivity(i);
        }
    }
