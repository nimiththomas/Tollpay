...
public class NewUpdateTollLocation extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_new_update_toll_location);

        getSupportActionBar().setTitle("Toll Location");
    ...
    protected void onResume() {
        ...
        if (!checkPlayServices()) {
            editLocation.setText("You need to install Google Play Services to use the App properly");
        }
    }
    ...
    public class UpdateLocation extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String s) {
            ...
            Toast.makeText(NewUpdateTollLocation.this, s, Toast.LENGTH_SHORT).show();

            if (s.equals("Succesfully Updated")) {
                //  sh.edit().putBoolean("first_time",false).commit();

                Intent i = new Intent(NewUpdateTollLocation.this, TollHome.class);
                startActivity(i);


            } else {
                Toast.makeText(NewUpdateTollLocation.this, "Updation Failed...Try Again", Toast.LENGTH_SHORT).show();
            }
        }
    }
                ...
                if (permissionsRejected.size() > 0) {
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                        if (shouldShowRequestPermissionRationale(permissionsRejected.get(0))) {
                            new AlertDialog.Builder(NewUpdateTollLocation.this).
