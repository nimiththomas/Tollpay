...
public class EditAmbulanceProfile extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_edit_ambulanceprofile);
       ...
       // img.setBackgroundResource(R.drawable.ic_account_circle_blue_24dp);
        ...
        SharedPreferences sharedPreferences = getSharedPreferences("ambulance", MODE_PRIVATE);
        userid = sharedPreferences.getString("ambid", "");
    }
...
//    }
    ...
    public  class updateprofile extends AsyncTask<String,String,String>
    {
        ...
        protected void onPostExecute(String s) {
            ...
            Toast.makeText(EditAmbulanceProfile.this, s, Toast.LENGTH_SHORT).show();

            Intent i=new Intent(EditAmbulanceProfile.this,AmbulanceProfile.class);
            startActivity(i);
    ...
    public void onClick(View v) {
        ...
        update.execute(userid,name1,email1,phone1,address1);
