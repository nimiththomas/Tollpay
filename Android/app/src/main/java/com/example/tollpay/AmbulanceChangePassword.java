...
public class AmbulanceChangePassword extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ambulancechange_password);
...
//    }
    ...
    public class changepassword extends AsyncTask<String,String,String>
    {
        ...
        protected void onPostExecute(String s) {
            ...
            Toast.makeText(AmbulanceChangePassword.this, s, Toast.LENGTH_SHORT).show();

            Intent i=new Intent(AmbulanceChangePassword.this,AmbulanceProfile.class);
            startActivity(i);
        }
    }
